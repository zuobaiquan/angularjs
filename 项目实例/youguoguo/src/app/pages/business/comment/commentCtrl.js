(function() {
    ...
    function commentCtrl($scope, apiRequest,toastr,baUtil,modalsService) {
        $scope.smartTable = {
            pageSize: 5,
            searchContent: '',
            start:"",
        ...
        $scope.getList = function(tableState) {
            ...
            $scope.persons=[];
            apiRequest.post('/admin/Evaluate/evaluateList', params, function(res) {
        ...
        $scope.isChecked=function(){
            ...
            if(delid.length==0){
                toastr.error("请选择待操作项", '');
                return;
            }
            $scope.modal = {
                url:'/admin/Evaluate/updateDeleteStatus',
                params: {
                    id:delid
                }
            };
            modalsService.normal('app/pages/business/comment/delreason.html','commenteditCtrl',$scope.modal,function(){});
        }
