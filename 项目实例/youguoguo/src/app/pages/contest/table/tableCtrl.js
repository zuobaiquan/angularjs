(function() {
    ...
    /** @ngInject */
    function tableCtrl($scope,apiRequest,$uibModal) {
        $scope.smartTable = {
            pageSize: 50,
            searchContent: ''
        }; //设置每页默认条数
        ...
        $scope.getList = function(tableState) {
            ...
            apiRequest.get('/admin/maths/list', params, function(res) {
        ...
        $scope.tableDetail=function(id){
          ...
          $uibModal.open({
              animation: true,
              templateUrl: 'app/pages/contest/table/tabledetail.html',
