angular.module('textarea-input', ['ui.bootstrap'])
    .directive("textareaInput", function() {
        return {
            ...
            template: function(elem, attr) {
                ...
                res+='<textarea class="form-control" ng-required='+required+' name='+attr.name+' maxlength='+len+' placeholder='+placeholder+' ng-model="textInput">';
                res+='</textarea>';
